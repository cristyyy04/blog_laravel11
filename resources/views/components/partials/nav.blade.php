    ...
    >
      ...
      <div class="-mr-4 flex items-center">
        ...
        <div class="ml-8 hidden space-x-8 md:flex">
          <a class="px-3 py-2 {{ request()->routeIs('about') ? 'text-gray-500' : ' text-sky-500'}}" href="{{route('home')}}"> Home </a>
          <a
            class="px-3 py-2 {{ request()->routeIs('about') ? 'text-gray-500' : ' text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500' }}"
href="{{route('about')}}"
          >
            About
          </a>
          <a
            class="px-3 py-2 {{ request()->routeIs('posts.*') ? 'text-gray-500' : ' text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500' }}"
           href="{{route('posts.index')}}"
          >
            Blog
          </a>
          <a
            class="px-3 py-2 {{ request()->routeIs('contact') ? 'text-gray-500' : ' text-slate-600 transition-colors hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-500' }}"
href="{{route('contact')}}"
          >
            Contact
          </a>
    ...
    >
     ...
     href="{{route('home')}}"
      ...
      <a
    href="{{route('about')}}"
        class="block rounded-md px-3 py-2 {{ request()->routeIs('about') ? 'text-gray-500' : ' text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white' }}"
      >
        About
      </a>
      <a
       href="{{route('posts.index')}}"
        class="block rounded-md px-3 py-2 {{ request()->routeIs('posts.index') ? 'text-gray-500' : ' text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white' }}"
      >
        Blog
      </a>
      <a
        href="{{route('contact')}}"
        class="block rounded-md px-3 py-2 {{ request()->routeIs('contact') ? 'text-gray-500' : ' text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white' }}"
      >
        Contact
      </a>
    </div>
